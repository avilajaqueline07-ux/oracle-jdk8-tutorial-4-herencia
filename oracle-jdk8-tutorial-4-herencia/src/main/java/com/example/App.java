...
public class App {
	public static void main(String[] args) {
		...
		empleado1.setPrimerApellido("Martinez");
		...
		// Empleado empleado2 = new Empleado("Maria", "Lopez", "Martinez",
		// Genero.FEMENINO);
		 ...
		 * que recibia los 4 argumentos que recibe este constructor, PERO en su lugar
		 * tenemos algo mucho, pero mucho, mejor, que es el patron Builder que nos
		 * permite crear/instanciar cualquier objeto aunque no tengamos el constructor
		 * explicitamente, ademas que se hace innecesario suministrar los campos de la
		 * clase en orden .
		 */
		...
		Empleado empleado2 = Empleado.builder()
				...
				.salario(new BigDecimal(2000.50))
				.departamento(Departamento.INFORMATICA)
				.build();

		Empleado empleado3 = new Empleado(new BigDecimal(2500.25), Departamento.CONTABILIDAD);
		...
		// Empleado empleado4 = new Empleado("Ana", "Gomez", "Perez", Genero.FEMENINO,
		// new BigDecimal(3000.50),
		// Departamento.RRHH);
		Empleado empleado4 = Empleado.builder()
				.nombre("Ana").primerApellido("Gomez")
				.segundoApellido("Perez")
				.genero(Genero.FEMENINO)
				.salario(new BigDecimal(3000.50))
